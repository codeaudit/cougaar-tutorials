...
public class FrontPageServlet extends ComponentServlet
{
      ...
      HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        out.println(
          // header
          "<html><head><title>Mandelbrot Servlet</title></head><body>"
          + "<h2>Mandelbrot Servlet</h2>"
          + // zoom out
          ...
          + "\" src=\"" + imgURI + "?" + args.toString("&$key=$value") + "\"/>\n"
          + // selection
          "<form method=\"GET\" name=\"f\" action=\"" + req.getRequestURI()
          + "\">\n"
          + args.toString(
          " $key=<input name=\"$key\" type=\"text\" size=\"4\""
          + " value=\"$value\">\n")
