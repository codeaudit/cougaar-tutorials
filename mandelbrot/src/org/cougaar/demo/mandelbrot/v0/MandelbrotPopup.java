...
/**
 * A minimal non-Cougaar application that computes the Mandelbrot Set image data
 * and either writes it to a file or pops up a UI.
 * <p>
 * To write to a file, specify a "file=<i>String</i>" argument. If no file is
 * specified then the image will be displayed in a popup Swing UI.
 * <p>
 * Usage is:
 * 
 * <pre>
...
public class MandelbrotPopup {
   ...
   public static void main(String[] sa) {
      ...
      byte[] data =
            FractalMath.mandelbrot(args.getInt("width"), args.getInt("height"), args.getDouble("x_min"), args.getDouble("x_max"),
      ...
      ImageOutput.displayImage(args.getInt("width"), args.getInt("height"), data);
