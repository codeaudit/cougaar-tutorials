...
/**
 * This plugin advertises a {@link FractalService} that computes the Julia Set.
 * <p>
 * Two optional plugin parameters are supported, where the defaults are:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * @see MandelbrotCalculator The MandelbrotCalculator is a pluggable replacement
 *      for this plugin
 */
public class JuliaCalculator
    ...
    * <p>
    * A couple interesting configurations from that page are:
    * <ul>
    ...
    * </ul>
    */
   private static final Arguments DEFAULT_ARGS = new Arguments(new String[] {
      "cx=-0.70176",
      "cy=-0.3842"
   });
   ...
   protected byte[] calculate(int width, int height, double min_x, double max_x, double min_y, double max_y) {
      return FractalMath.julia(width, height, min_x, max_x, min_y, max_y, args.getDouble("cx"), args.getDouble("cy"));
   }
}
