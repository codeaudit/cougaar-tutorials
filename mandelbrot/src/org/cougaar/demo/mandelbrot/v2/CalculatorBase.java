...
public abstract class CalculatorBase
   ...
   public void load() {
      ...
      FractalService svc = new FractalService() {
         public byte[] calculate(int width, int height, double min_x, double max_x, double min_y, double max_y) {
            return CalculatorBase.this.calculate(width, height, min_x, max_x, min_y, max_y);
         }
      };
   ...
   private static final class TrivialServiceProvider
