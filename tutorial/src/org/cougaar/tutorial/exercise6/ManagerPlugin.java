...
public class ManagerPlugin
   ...
   protected Task makeTask(Asset what) {
      ...
      ScoringFunction scorefcn =
            ScoringFunction.createNearOrAbove(AspectValue.newAspectValue(AspectType.START_TIME, cal2.getTime().getTime()), slope);
      Preference pref = factory.newPreference(AspectType.START_TIME, scorefcn);
      preferences.add(pref);

      cal2.add(Calendar.YEAR, 1);
      scorefcn =
            ScoringFunction.createNearOrBelow(AspectValue.newAspectValue(AspectType.END_TIME, cal2.getTime().getTime()), slope);
