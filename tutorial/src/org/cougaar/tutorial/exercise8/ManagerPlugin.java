...
public class ManagerPlugin
   ...
   protected Task makeTask(Asset what) {
      ...
      ScoringFunction scorefcn =
            ScoringFunction.createNearOrAbove(AspectValue.newAspectValue(AspectType.START_TIME, cal2.getTime().getTime()),
                                              0.0000001);
      ...
      scorefcn =
            ScoringFunction.createNearOrBelow(AspectValue.newAspectValue(AspectType.END_TIME, cal2.getTime().getTime()), 0.0000001);
