 ...
 * @version $Id: DevelopmentAllocatorPlugin.java,v 1.1 2002-02-12 19:30:15 jwinston Exp $
 **/
public class DevelopmentAllocatorPlugin extends ComponentPlugin
{
  ...
  public void execute() {
    ...
    // todo: un-plan any rescinded tasks (use the releaseWork(Task) method (below))
    ...
    // Plan any new software development tasks with no allocation
    ...
    // todo: Re-plan any changed allocations
