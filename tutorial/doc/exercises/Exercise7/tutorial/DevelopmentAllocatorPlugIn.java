 ...
 * @version $Id: DevelopmentAllocatorPlugIn.java,v 1.4 2002-01-15 20:19:53 cbrundic Exp $
 **/
public class DevelopmentAllocatorPlugIn extends ComponentPlugin
{
  ...
  private int allocateTask(Task task, int after) {
    ...
    while ((!allocated) && (programmers.size() > 0)) {
      ...
      // todo:  Set allocation results based on aspect results and
      //        the success of the allocation
