...
** This loads the tasks servlet into your agent which allows you to view the blackboard. 
** This will allow you to 
** drill into the live plan for the agent through your web browser.  Try it.
** use : http://localhost:8800/$Hanoi/tasks
...
You can use the tasks servlet to trace through the plan.  Its a little tedious, but you 
