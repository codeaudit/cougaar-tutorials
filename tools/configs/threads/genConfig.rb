...
<!--
#{@societyName}: Test Society for pingers on a single agents blackboard with a limit of #{x} threads.
-->
<society>
  <node name="#{@nodeName}">
    <vm_parameter name='-Dorg.cougaar.society.xsl.param.pluginThreadPool' value='#{x}'/>
