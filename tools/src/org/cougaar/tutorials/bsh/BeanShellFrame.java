...
/**
 * A frame containing a Bean Shell console.  Unfortunately, I can't
...
public class BeanShellFrame extends JFrame {
   ...
   /** The Bean Shell console window. */
    ...
    /**
     * Constructs a new Bean Shell Frame.  The frame consists of a
    ...
    /**
     * Performs any desired initializations on the Bean Shell
    ...
    /**
     * Creates the button panel on the frame.  The default is a close
    ...
    /**
     * Sets the bean shell variable <code>var</code> to
     * <code>obj</code> in the bean shell interpreter of this frame.
     *
     * @param var the bean shell variable to set
     * @param obj the value of the beans shell variable
     * <code>var</code>
     */
    ...
    /**
     * Runs this interpreter in the current thread.  I don't think
