...
public class PingReply
   ...
   public PingReply(UIDService uids, int count, MessageAddress originatorAgent, String orginatorPlugin, MessageAddress targetAgent,
                    String targetPlugin, byte[] payload) {
      super(uids.nextUID());
      this.count = count;
