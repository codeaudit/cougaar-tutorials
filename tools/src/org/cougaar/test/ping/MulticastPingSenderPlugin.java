...
public class MulticastPingSenderPlugin extends TodoPlugin {
    ...
    public void executeStartRun(StartRequest request) {
        ...
        Object query = new PingQuery(uids, -preambleCount, 
                                     ...
                                     agentId, pluginId, targetMulticastGroup, targetPlugin,
                                     payload);
    ...
    public boolean isMyPingReply(SimpleRelay relay) {
         if (agentId.equals(relay.getTarget()) && 
                 targetMulticastGroup.equals(relay.getSource())) {
