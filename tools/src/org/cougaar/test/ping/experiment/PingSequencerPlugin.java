...
public class PingSequencerPlugin
   ...
   @Cougaar.Arg(name = "loops", defaultValue = "3", description = "Number of Steady State Collection Loops")
   public int loops;
   ...
   public void load() {
      ...
      addStep(START_TEST, steadyStateWaitMillis, null, PING_SIZE_PROPERTY + "=" + payloadSize, PING_DELAY_PROPERTY + "="
            + interPingDelay, PING_STATISTICS_PROPERTY + "=" + statisticsKind);
