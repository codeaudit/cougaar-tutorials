...
public class ReceiptPingSenderPlugin extends TodoPlugin {
...
//        attrs.setAttribute(AttributeConstants.MESSAGE_SEND_TIMEOUT_ATTRIBUTE, 5);
    ...
    public void executeMessageReceipt(SimpleRelay receipt) {
        ...
        if (rawReply instanceof MessageAttributes) {
            ...
            reply.clearAttributes(); // signal to show we've already processed the receipt
        }
    }
