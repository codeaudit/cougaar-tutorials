 ...
 */
public class PingBBSubscriberPlugin extends AnnotatedSubscriptionsPlugin {
    ...
    @Cougaar.Arg(name = "wasteSubscriptionTime", defaultValue = "0", 
                 description = "Wallclock time for a waste spin loop for each subscription")
