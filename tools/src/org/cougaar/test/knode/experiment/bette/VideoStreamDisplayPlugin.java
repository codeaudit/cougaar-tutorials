      ...
      if (streamIncarnation == newIncarnation) {
         ...
         if (newCount == lastCount + 1) {
            ...
            if (log.isInfoEnabled()) {
               ...
               log.info("Image " + imageHolder.getCount() + " transfer delay =" + (now - newTimeStamp));
            }
         ...
         frame.update(imageHolder.getImage(), newTimeStamp);
         if (log.isInfoEnabled()) {
            log.info("Start new image stream " + imageHolder.getStreamName() + " incarnation=" + newIncarnation);
         }
      } else if (newIncarnation < streamIncarnation) {
