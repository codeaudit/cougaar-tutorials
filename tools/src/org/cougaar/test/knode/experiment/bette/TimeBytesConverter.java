...
/**
 * 
 * Class to convert Time as long into byte array Hack for now: Assume that time
 * has granularity of 128 seconds and 1/128 of a second So time is represented
 * as fixed point number in 2 byte array
 */
