...
public class TimedImageBasePlugin
      extends AnnotatedSubscriptionsPlugin
      implements TimedImageService {

   @Cougaar.Arg(name = "cacheImages", defaultValue = "true", description = "Should Images be cached in memory after first read from disk ")
   public boolean isCacheImages;

   @Cougaar.Arg(name = "imageDirectory", defaultValue = "/org/cougaar/test/knode/experiment/bette/images/big", description = "Directory where images are stored. Use the appropriate format based on where the images are stored")
   public String imageDirectory;

   @Cougaar.Arg(name = "imageFileExtension", defaultValue = ".jpg", description = "File extension of image files")
   public String imageFileExtension;

   @Cougaar.Arg(name = "imageFrameRate", defaultValue = "5.0", description = "Frames per Second")
   public double frameRate;

   @Cougaar.Arg(name = "loopBackwards", defaultValue = "false", description = "Run the image sequence backwards, instead of jumping back to the beginning")
