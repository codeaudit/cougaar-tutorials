...
public class ImageLoop {
   ...
   /*
    * The time for the next image, inclusive. If there is an image for the
    * current time, return currentTime
    */
   ...
   /*
    * The loop time for the next image, exclusive with wrap. Scan forward to the
    * next image (not including the image at the current time) If the current
    * time is last image then skip to the first image
    */
   ...
   /*
    * The wall clock time for setting a timer from current time to next image,
    * exclusive with wrap. Scan forward to the next image (not including the
    * image at the current time). Return the delta time between current time and
    * the next image. If the current time is last image then skip to the first
    * image and include remaining time to end of loop and beginning of loop
    */
   ...
   /*
    * Image at loop time. If no image at that time, returns null
    */
   ...
   /*
    * Loop time for first image if no image, returns null
    */
